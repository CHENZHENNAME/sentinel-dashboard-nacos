 ...
 */
@Controller
@RequestMapping(value = "/nacos/degrade", produces = MediaType.APPLICATION_JSON_VALUE)
public class DegradeRuleNacosController {

    private final Logger logger = LoggerFactory.getLogger(DegradeRuleNacosController.class);
