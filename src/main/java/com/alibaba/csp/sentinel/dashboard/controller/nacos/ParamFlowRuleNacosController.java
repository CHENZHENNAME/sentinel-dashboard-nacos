...
public class ParamFlowRuleNacosController {

    private final Logger logger = LoggerFactory.getLogger(ParamFlowRuleNacosController.class);
    ...
    @Autowired
    @Qualifier("paramFlowFlowRuleNacosPublisher")
