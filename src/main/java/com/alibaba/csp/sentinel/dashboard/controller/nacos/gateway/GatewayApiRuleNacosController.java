 ...
 */
package com.alibaba.csp.sentinel.dashboard.controller.nacos.gateway;
 ...
 */
@RestController
@RequestMapping(value = "/nacos/gateway/api")
public class GatewayApiRuleNacosController {

    private final Logger logger = LoggerFactory.getLogger(GatewayApiRuleNacosController.class);
