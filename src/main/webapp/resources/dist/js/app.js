"use strict";
angular.module("sentinelDashboardApp", ["oc.lazyLoad", "ui.router", "ui.bootstrap", "angular-loading-bar", "ngDialog", "ui.bootstrap.datetimepicker", "ui-notification", "rzTable", "angular-clipboard", "selectize", "angularUtils.directives.dirPagination"]).factory("AuthInterceptor", ["$window", "$state",
    function(t, r) {
        return {
            responseError: function(e) {
                return 401 === e.status && (t.localStorage.removeItem("session_sentinel_admin"), r.go("login")),
                    e
            },
            response: function(e) {
                return e
                    ...
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                ...
                                files: ["app/scripts/controllers/login.js"]
                            })
                        }]
                }
            }).state("dashboard", {
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/main.js"]
                            })
                        }]
                }
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/flow_v1.js"]
                            })
                        }]
                }
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/flow_v2.js"]
                            })
                        }]
                }
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/param_flow.js"]
                            })
                        }]
                }
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/cluster_single.js"]
                            })
                        }]
                }
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/authority.js"]
                            })
                        }]
                }
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/degrade.js"]
                            })
                        }]
                }
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/system.js"]
                            })
                        }]
                }
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/machine.js"]
                            })
                        }]
                }
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/identity.js"]
                            })
                        }]
                }
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/gateway/identity.js"]
                            })
                        }]
                }
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/metric.js"]
                            })
                        }]
                }
            })
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/gateway/api.js"]
                            })
                        }]
                }
                ...
                resolve: {
                    loadMyFiles: ["$ocLazyLoad",
                        function(e) {
                            return e.load({
                                name: "sentinelDashboardApp",
                                files: ["app/scripts/controllers/gateway/flow.js"]
                            })
                        }]
                }
...
app.filter("range", [function() {
    ...
    (app = angular.module("sentinelDashboardApp")).service("VersionService", ["$http",
        function(e) {
    ...
    (app = angular.module("sentinelDashboardApp")).service("AuthService", ["$http",
        function(t) {
            this.check = function() {
                return t({
                    url: "/auth/check",
    ...
    (app = angular.module("sentinelDashboardApp")).service("AppService", ["$http",
        function(e) {
    ...
    (app = angular.module("sentinelDashboardApp")).service("FlowServiceV1", ["$http",
        function(a) {
            function t(e) {
    ...
    (app = angular.module("sentinelDashboardApp")).service("FlowServiceV2", ["$http",
        function(a) {
            function t(e) {
                return void 0 === e || "" === e || isNaN(e) || e <= 0
            }
    ...
    (app = angular.module("sentinelDashboardApp")).service("FlowNacosService", ["$http",
        function(a) {
            function t(e) {
                return void 0 === e || "" === e || isNaN(e) || e <= 0
            }
    ...
    (app = angular.module("sentinelDashboardApp")).service("DegradeService", ["$http",
        function(a) {
            this.queryMachineRules = function(e, t, r) {
                return a({
    ...
    (app = angular.module("sentinelDashboardApp")).service("DegradeNacosService", ["$http",
        function(a) {
            this.queryMachineRules = function(e, t, r) {
                return a({
                    url: "/nacos/degrade/rules.json",
                    params: {
                        app: e,
                        ip: t,
                        port: r
    ...
    (app = angular.module("sentinelDashboardApp")).service("SystemService", ["$http",
        function(a) {
            this.queryMachineRules = function(e, t, r) {
                return a({
                ...
                this.newRule = function(e) {
                    ...
                    return 0 == e.grade ? t.highestSystemLoad = e.highestSystemLoad: 1 == e.grade ? t.avgRt = e.avgRt: 2 == e.grade ? t.maxThread = e.maxThread: 3 == e.grade ? t.qps = e.qps: 4 == e.grade && (t.highestCpuUsage = e.highestCpuUsage),
                        a({
                            url: "/system/new.json",
                            params: t,
                            method: "GET"
    ...
    (app = angular.module("sentinelDashboardApp")).service("SystemNacosService", ["$http",
        function(a) {
            this.queryMachineRules = function(e, t, r) {
                return a({
                    url: "/nacos/system/rules.json",
                    params: {
                        app: e,
                        ip: t,
                        port: r
    ...
    (app = angular.module("sentinelDashboardApp")).service("MachineService", ["$http", "$httpParamSerializerJQLike",
        function(a, o) {
            this.getAppMachines = function(e) {
                return a({
                    url: "app/" + e + "/machines.json",
                    method: "GET"
                })
            },
    ...
    (app = angular.module("sentinelDashboardApp")).service("IdentityService", ["$http",
        function(a) {
    ...
    (app = angular.module("sentinelDashboardApp")).service("MetricService", ["$http",
        function(l) {
    ...
    angular.module("sentinelDashboardApp").service("ParamFlowService", ["$http",
        function(a) {
            function o(e) {
            ...
            this.queryMachineRules = function(e, t, r) {
                ...
                this.checkRuleValid = function(e) {
                    if (!e.resource || "" === e.resource) return alert("资源名称不能为空"),
                        !1;
                    if (1 != e.grade) return alert("未知的限流模式"),
                        !1;
                    if (e.count < 0) return alert("限流阈值必须大于等于 0"),
                        !1;
                    if (void 0 === e.paramIdx || "" === e.paramIdx || isNaN(e.paramIdx) || e.paramIdx < 0) return alert("热点参数索引必须大于等于 0"),
                        !1;
                    if (void 0 !== e.paramFlowItemList) for (var t = 0; t < e.paramFlowItemList.length; t++) {
                        var r = e.paramFlowItemList[t];
                        if (o(r)) return alert("热点参数例外项不合法，请检查值和类型是否正确：参数为 " + r.object + ", 类型为 " + r.classType + ", 限流阈值为 " + r.count),
                            !1
                    }
                    return ! 0
                }
        }]),
    angular.module("sentinelDashboardApp").service("ParamFlowNacosService", ["$http",
        function(a) {
            function o(e) {
                return ! ("int" !== (r = e.classType) && "double" !== r && "float" !== r && "long" !== r && "short" !== r || void 0 !== (t = e.object) && "" !== t && !isNaN(t)) || ("byte" === e.classType && (a = e.object, o = -128, i = 127, void 0 === a || "" === a || isNaN(a) || a < o || i < a) || (void 0 === e.object || void 0 === e.classType || (void 0 === (l = e.count) || "" === l || isNaN(l) || l < 0)));
                var t, r, a, o, i, l
    ...
    angular.module("sentinelDashboardApp").service("AuthorityRuleService", ["$http",
        function(a) {
            this.queryMachineRules = function(e, t, r) {
                return a({
                    url: "/authority/rules",
    ...
    angular.module("sentinelDashboardApp").service("AuthorityRuleNacosService", ["$http",
        function(a) {
            this.queryMachineRules = function(e, t, r) {
                return a({
    ...
    angular.module("sentinelDashboardApp").service("ClusterStateService", ["$http",
        function(a) {
            this.fetchClusterUniversalStateSingle = function(e, t, r) {
                ...
                this.fetchClusterServerStateOfApp = function(e) {
                    return a({
                        url: "/cluster/server_state/" + e,
                        method: "GET"
                    })
                },
                this.fetchClusterClientStateOfApp = function(e) {
                    return a({
                        url: "/cluster/client_state/" + e,
                        method: "GET"
                    })
                },
                ...
                this.applyClusterFullAssignOfApp = function(e, t) {
                    return a({
                        url: "/cluster/assign/all_server/" + e,
                        data: t,
                        method: "POST"
                    })
                },
                this.applyClusterSingleServerAssignOfApp = function(e, t) {
                    return a({
                        url: "/cluster/assign/single_server/" + e,
                        data: t,
                        method: "POST"
                    })
                },
                this.applyClusterServerBatchUnbind = function(e, t) {
                    return a({
                        url: "/cluster/assign/unbind_server/" + e,
                        data: t,
                        method: "POST"
                    })
                }
        ...
        function(a) {
            this.queryApis = function(e, t, r) {
                ...
                this.checkApiValid = function(e, t) {
                    if (void 0 === e.apiName || "" === e.apiName) return alert("API名称不能为空"),
                        !1;
                    if (null == e.predicateItems || 0 === e.predicateItems.length) return alert("至少有一个匹配规则"),
                        !1;
                    for (var r = 0; r < e.predicateItems.length; r++) {
                        var a = e.predicateItems[r].pattern;
                        if (void 0 === a || "" === a) return alert("匹配串不能为空，请检查"),
                            !1
                    }
                    return - 1 === t.indexOf(e.apiName) || (alert("API名称(" + e.apiName + ")已存在"), !1)
                }
        }]),
    (app = angular.module("sentinelDashboardApp")).service("GatewayApiNacosService", ["$http",
        function(a) {
            this.queryApis = function(e, t, r) {
                return a({
                    url: "/nacos/gateway/api/list.json",
                    params: {
                        app: e,
                        ip: t,
                        port: r
                ...
                this.newApi = function(e) {
                    return a({
                        url: "/nacos/gateway/api/new.json",
                        data: e,
                        method: "POST"
                    })
                },
                this.saveApi = function(e) {
                    return a({
                        url: "/nacos/gateway/api/save.json",
                        data: e,
                        method: "POST"
                    })
                },
                this.deleteApi = function(e) {
                    ...
                    return a({
                        url: "/nacos/gateway/api/delete.json",
                        params: t,
                        method: "POST"
                    })
                },
    ...
    (app = angular.module("sentinelDashboardApp")).service("GatewayFlowService", ["$http",
        function(a) {
            this.queryRules = function(e, t, r) {
                ...
                this.checkRuleValid = function(e) {
                    if (void 0 === e.resource || "" === e.resource) return alert("API名称不能为空"),
                        !1;
                    if (null != e.paramItem && (2 == e.paramItem.parseStrategy || 3 == e.paramItem.parseStrategy || 4 == e.paramItem.parseStrategy)) {
                        if (void 0 === e.paramItem.fieldName || "" === e.paramItem.fieldName) return alert("当参数属性为Header、URL参数、Cookie时，参数名称不能为空"),
                            !1;
                        if ("" === e.paramItem.pattern) return alert("匹配串不能为空"),
                            !1
                    }
                    return ! (void 0 === e.count || e.count < 0) || (alert((1 === e.grade ? "QPS阈值": "线程数") + "必须大于等于 0"), !1)
                }
        }]),
    (app = angular.module("sentinelDashboardApp")).service("GatewayFlowNacosService", ["$http",
        function(a) {
            this.queryRules = function(e, t, r) {
                return a({
                    url: "/nacos/gateway/flow/list.json",
                    params: {
                        app: e,
                        ip: t,
                        port: r
                ...
                this.newRule = function(e) {
                    return a({
                        url: "/nacos/gateway/flow/new.json",
                        data: e,
                        method: "POST"
                    })
                },
                this.saveRule = function(e) {
                    return a({
                        url: "/nacos/gateway/flow/save.json",
                        data: e,
                        method: "POST"
                    })
                },
                this.deleteRule = function(e) {
                    ...
                    return a({
                        url: "/nacos/gateway/flow/delete.json",
                        params: t,
                        method: "POST"
                    })
                },
